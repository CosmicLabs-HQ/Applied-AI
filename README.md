...
- Exposure to RL or post-training methods (RLHF, RLVR, reward design) and how they shape agent behavior
- Open-source contributions in agent tooling, developer infrastructure, or anything you shipped that people use
- Prior work in an early-stage environment where you owned features end to end
- Experience with real-time or streaming systems, distributed systems, or performance-sensitive applications

## How to Apply

Email the following to team@cosmiclabs.io:

**Subject line:** MTS, Agentic Systems / [Your Name]
